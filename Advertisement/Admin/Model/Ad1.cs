...
{
	/// <summary>
	/// Strongly-typed collection for the Ad1 class.
	/// </summary>
///ssss
	[Serializable]
	public partial class Ad1Collection : ActiveList<Ad1,Ad1Collection>
	{	   
		public Ad1Collection() {}

	}

	/// <summary>
	/// This is an ActiveRecord class which wraps the tblAd1 table.
	/// </summary>
	[Serializable]
	public partial class Ad1 : ActiveRecord<Ad1>, IActiveRecord
	{
		...
		public Ad1(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Ad1(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tblAd1", TableType.Table, DataService.GetInstance("csmDefaultDB"));
				...
				colvarAdContactNo.IsNullable = true;
				...
				DataService.Providers["csmDefaultDB"].AddSchema("tblAd1",schema);
			}
